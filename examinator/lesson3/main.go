...
func run(strArgs []string) int {
	...
	if err := ex.Download("ex3-1.html", saveFile); err != nil {
		printf("error downloading ex3-1.html: %v", err)
		return exitCodeError
	}

	if err := ex.Download("ex3-1.js", saveFile); err != nil {
		printf("error downloading ex3-1.js: %v", err)
		return exitCodeError
	}

	if err := ex.Download("ex3-2.html", saveFile); err != nil {
		printf("error downloading ex3-2.html: %v", err)
		return exitCodeError
	}

	if err := ex.Download("ex3-2.js", saveFile); err != nil {
		printf("error downloading ex3-2.js: %v", err)
		return exitCodeError
	}

	if err := ex.Download("ex3-3.html", saveFile); err != nil {
		printf("error downloading ex3-3.html: %v", err)
		return exitCodeError
	}

	if err := ex.Download("ex3-3.js", saveFile); err != nil {
		printf("error downloading ex3-3.js: %v", err)
		return exitCodeError
	}

	if err := ex.Download("ex3-4.html", saveFile); err != nil {
		printf("error downloading ex3-4.html: %v", err)
		return exitCodeError
	}

	if err := ex.Download("ex3-4.js", saveFile); err != nil {
		printf("error downloading ex3-4.js: %v", err)
		return exitCodeError
	}
